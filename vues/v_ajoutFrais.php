...
<tr>
	...
	<td>
		<input  type='text' name=dateFrais  size='30' maxlength='45' class='form-control' style='width: 200px'>
	</td>
</tr>
<tr>
	<td>Description du frais</td>
	<td>
		<input  type='text' name=description  size='50' maxlength='100' class='form-control' style='width: 200px'>
	</td>
</tr>
<tr>
	<td>Montant engage</td>
	<td>
		<input  type='text' name=montant  size='30' maxlength='45' class='form-control' style='width: 200px'>
	</td>
</tr>
<tr>
<td>Justificatif</td>
